...
projectConfiguration <- ospsuite.reportingframework:::iniTestProject(rootDirectory = NULL,
                                       verbose = FALSE,
...
invisible(lapply(configFiles,function(f){file.copy(
  from = f,
...
invisible(lapply(dataFiles,function(f){file.copy(
  from = f,
...
# Set isValidRun to TRUE if you want to execute the workflow as a final valid run.
...
tmp <- xlsxReadData(wb = projectConfiguration$dataImporterConfigurationFile,
  sheetName = "DataFiles",
