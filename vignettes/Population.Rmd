...
If the same parameters are adressed by the Poulation and the Scenario setup (e.g. by referencing different ModelParameter sheets) the scenario setup overwrites the setup of the population. 
