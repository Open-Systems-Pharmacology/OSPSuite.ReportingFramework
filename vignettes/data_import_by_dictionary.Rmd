...
- Data which is used in other configuration files is also updated: 
  ...
  - Sheet "DataGroupId" in the dataImportConfiguration file. All missing combinations of StudyId, group were added. Here you can add properties like the displayname for the report.  
  - Sheet "OutputPaths" in the Scenario definition file. All missing OutputPathIds are added. Her you can add output paths, molweights and display names for report.  
  - Sheet "IndividualBiometrics" in the Individual parameter file. All biometrics contained in the data are added.  
...
dataDT <- readObservedDataByDictionary(projectConfiguration,
...
In the "tpDictionary" sheet, define the data dictionary with the following columns:
  ...
  - **type**: Type of parameter used by the package. 
      ...
      - **identifier** all identifiers are mandatory:  
         ...
         - group: identifier for data group, typically a study arm
      ...
      - **timeprofile** columns used to process time profiles.
         ...
         for aggregated data the columns yErrorValues, yErrorType, nBelowLLOQ are also needed:
...
The individualId was contsructed as concatenation of study Id and Individual id. 
