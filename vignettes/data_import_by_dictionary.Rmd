...
TODO Data which is needed for plot configuration, such as identifiers for datagroups and outputs, biometrics of virtual populations are transferred during the data import to the corresponding configuration tables.
ADD GRAPHIC
