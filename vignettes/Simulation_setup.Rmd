...
During the data import via the `readObservedDataByDictionary` function, a sheet named 'VirtualTwinPopulation' is added to the 'Population.xlsx' with the following columns:
