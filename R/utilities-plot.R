...
#'
#' @param projectConfiguration A ProjectConfiguration object containing the project configuration settings. This should include paths to input files and output directories.
#' @param functionKey A character string that selects the plot function to use. Valid options depend on the available plot functions in your project. If NULL, a plot function must be provided via `plotFunction`.
#' @param plotFunction An optional function to be used for plotting. If provided, this will override the selection made by `functionKey`.
#' @param subfolder A character string specifying the subfolder where results will be saved. If `functionKey` is used, the default value will be the sheet name of the plot configuration.
#' @param configTableSheet A character string representing the name of the sheet in the configuration table from which to read plot configurations.
#' @param plotNames A character vector of plot names to filter which plots should be generated. If provided, the Rmd export is suppressed, and the function returns a list of generated plots instead of creating an Rmd file. If NULL, all plots specified in the configuration will be processed and exported to the Rmd file.
